...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Place] (100001)", my_place_str)
        self.assertIn("'id': '100001'", my_place_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        my_place = Place(id="101", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(my_place.id, "101")
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_place = Place()
        my_place.middle_name = "Edwin"
        my_place.my_number = 101
        self.assertEqual("Edwin", my_place.middle_name)
