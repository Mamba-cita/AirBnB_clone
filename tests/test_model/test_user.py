...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[User] (100001)", user1_str)
        self.assertIn("'id': '100001'", user1_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        user1 = User(id="101", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(user1.id, "101")
