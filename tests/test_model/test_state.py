...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[State] (100001)", state_str)
        self.assertIn("'id': '100001'", state_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        state = State(id="401", created_at=my_date_iso, updated_at=my_date_iso)
        self.assertEqual(state.id, "401")
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        state = State()
        state.middle_name = "Edwin"
        state.my_number = 777
        self.assertEqual("Edwin", state.middle_name)
