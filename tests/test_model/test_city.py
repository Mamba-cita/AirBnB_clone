...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[City] (100001)", my_city_str)
        self.assertIn("'id': '100001'", my_city_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        my_city = City(id="401", created_at=my_date_iso,
                       updated_at=my_date_iso)
        self.assertEqual(my_city.id, "401")
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        my_city = City()
        my_city.middle_name = "Edwin"
        my_city.my_number = 101
        self.assertEqual("Edwin", my_city.middle_name)
