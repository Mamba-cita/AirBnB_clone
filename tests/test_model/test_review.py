...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Review] (100001)", review_str)
        self.assertIn("'id': '100001'", review_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        review = Review(id="101", created_at=my_date_iso,
                        updated_at=my_date_iso)
        self.assertEqual(review.id, "101")
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        review = Review()
        review.middle_name = "Edwin"
        review.my_number = 101
        self.assertEqual("Edwin", review.middle_name)
