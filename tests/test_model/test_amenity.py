...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[Amenity] (100001)", amenity_str)
        self.assertIn("'id': '100001'", amenity_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        amenity1 = Amenity(id="101", created_at=my_date_iso,
                           updated_at=my_date_iso)
        self.assertEqual(amenity1.id, "101")
...
class TestAmenity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        amenity1 = Amenity()
        amenity1.middle_name = "Edwin"
        amenity1.my_number = 101
        self.assertEqual("Edwin", amenity1.middle_name)
